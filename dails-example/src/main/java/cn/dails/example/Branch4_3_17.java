 ...
 */
public class Branch4_3_17 extends Example {

    static String defFile = "branch4_3_17";
    @Override
...
//        Tools.mkFile(workUrl + "/domain");
        ...
        Tools.mkFile(getRooturl() + "/src/main/resources/static/assets/js");
        Tools.mkFile(getRooturl() + "/src/main/resources/templates");
        Tools.mkFile(getJsUrl());
//        addLauncher();
        addConf();
        String utiljs = getRooturl() + "/src/main/resources/static/assets/js/util.js";
    ...
    public void addController() {
        ...
        File Search = new File(getWorkUrl() + "/bean/vo/" + replaceEntity(name) + "Search.java");
        createFile(Search, domainUrl, name, defFile+"/Search.txt");
                ...
                if (name.equals("show.html")) {
                    ...
                    for (int i = 0; i < filedNames.length; i++) {
                        if (!filedNames[i].equals("id") && !filedNames[i].equals("serialVersionUID")) {
                                temp += "            <dt class=\"col-sm-3\">"+filedNames[i]+"</dt>\n" +
                                    "            <dd class=\"col-sm-9\" th:text='${obj."+filedNames[i]+"}' ></dd>\n";
